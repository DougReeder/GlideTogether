/** intro.js - introductory text for an Glide Together world
...
<table style="width:100%">
    <tr><td colspan="2">Glide Together is designed for VR or mobile, but if you want to try it here:</td></tr>
...
`;
        ...
        let html = `
${closeBtnHtml}
<h1 style="text-align:center;">Glide Together</h1>
    <div class="wrapper">
      <div id="overview">
      ...
      <div style="font-family:serif; font-size: 0.75rem">
        ...
        <div><a href="https://github.com/DougReeder/glide-together">View source code and contribute</a> </div>
      </div>
    </div>
`;
